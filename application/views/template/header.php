...
<html lang="en">
	<head>
		...
		<!--[if lt IE 9]><script src="<?php base_url().'public/../../assets/js/ie8-responsive-file-warning.js'?>"></script><![endif]-->
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<a class="page-scroll" href="<?php echo base_url('protocolo')?>">Projetos</a>
						</li>
						<li>
							<a class="page-scroll" href="<?php echo base_url($url)?>"><?php echo $text;?></a>
						</li>						
					</ul>
				</div>
				<!-- /.navbar-collapse -->
